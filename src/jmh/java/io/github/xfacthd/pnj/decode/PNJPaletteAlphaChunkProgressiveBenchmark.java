...
public class PNJPaletteAlphaChunkProgressiveBenchmark
{
    private static final Path PATH_8BIT =  Constants.PATH_ROOT.resolve("transparency/tbwn3p08.png");
    ...
    {
        BenchmarkUtil.freeNativeBuffers(DATA_8BIT_NATIVE);
    }
}
