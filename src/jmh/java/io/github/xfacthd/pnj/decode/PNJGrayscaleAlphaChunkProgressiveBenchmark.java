...
public class PNJGrayscaleAlphaChunkProgressiveBenchmark
{
    private static final Path PATH_16BIT = Constants.PATH_ROOT.resolve("transparency/tbwn0g16.png");
    ...
    {
        BenchmarkUtil.freeNativeBuffers(DATA_16BIT_NATIVE);
    }
}
