...
public class PNJTruecolorProgressiveBenchmark
{
    private static final Path PATH_8BIT =  Constants.PATH_ROOT.resolve("basic/basn2c08.png");
    private static final Path PATH_16BIT = Constants.PATH_ROOT.resolve("basic/basn2c16.png");
