...
public class PNJPaletteInterlaceBenchmark
{
    private static final Path PATH_1BIT =  Constants.PATH_ROOT.resolve("interlace/basi3p01.png");
    private static final Path PATH_2BIT =  Constants.PATH_ROOT.resolve("interlace/basi3p02.png");
    private static final Path PATH_4BIT =  Constants.PATH_ROOT.resolve("interlace/basi3p04.png");
    private static final Path PATH_8BIT =  Constants.PATH_ROOT.resolve("interlace/basi3p08.png");
