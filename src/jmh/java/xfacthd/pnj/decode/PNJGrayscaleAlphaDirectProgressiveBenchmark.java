...
public class PNJGrayscaleAlphaDirectProgressiveBenchmark
{
    private static final Path PATH_8BIT =  Constants.PATH_ROOT.resolve("basic/basn4a08.png");
    private static final Path PATH_16BIT = Constants.PATH_ROOT.resolve("basic/basn4a16.png");
