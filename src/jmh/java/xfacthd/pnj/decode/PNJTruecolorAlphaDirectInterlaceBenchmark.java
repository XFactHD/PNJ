...
public class PNJTruecolorAlphaDirectInterlaceBenchmark
{
    private static final Path PATH_8BIT =  Constants.PATH_ROOT.resolve("interlace/basi6a08.png");
    private static final Path PATH_16BIT = Constants.PATH_ROOT.resolve("interlace/basi6a16.png");
