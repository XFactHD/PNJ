...
public class PNJTruecolorAlphaChunkProgressiveBenchmark
{
    private static final Path PATH_8BIT =  Constants.PATH_ROOT.resolve("transparency/tbrn2c08.png");
    private static final Path PATH_16BIT = Constants.PATH_ROOT.resolve("transparency/tbgn2c16.png");
