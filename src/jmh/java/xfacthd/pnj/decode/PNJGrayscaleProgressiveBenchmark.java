...
public class PNJGrayscaleProgressiveBenchmark
{
    private static final Path PATH_1BIT =  Constants.PATH_ROOT.resolve("basic/basn0g01.png");
    private static final Path PATH_2BIT =  Constants.PATH_ROOT.resolve("basic/basn0g02.png");
    private static final Path PATH_4BIT =  Constants.PATH_ROOT.resolve("basic/basn0g04.png");
    private static final Path PATH_8BIT =  Constants.PATH_ROOT.resolve("basic/basn0g08.png");
    private static final Path PATH_16BIT = Constants.PATH_ROOT.resolve("basic/basn0g16.png");
