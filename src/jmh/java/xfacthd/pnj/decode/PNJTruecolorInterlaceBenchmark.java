...
public class PNJTruecolorInterlaceBenchmark
{
    private static final Path PATH_8BIT =  Constants.PATH_ROOT.resolve("interlace/basi2c08.png");
    private static final Path PATH_16BIT = Constants.PATH_ROOT.resolve("interlace/basi2c16.png");
